...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ImageViewConfig::AbstractParamDescriptionConstPtr(new ImageViewConfig::ParamDescription<int>("colormap", "int", 0, "colormap", "{'enum': [{'name': 'NO_COLORMAP', 'type': 'int', 'value': -1, 'srcline': 9, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'NO_COLORMAP', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'AUTUMN', 'type': 'int', 'value': 0, 'srcline': 10, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_AUTUMN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'BONE', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_BONE', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'JET', 'type': 'int', 'value': 2, 'srcline': 12, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_JET', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'WINTER', 'type': 'int', 'value': 3, 'srcline': 13, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_WINTER', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'RAINBOW', 'type': 'int', 'value': 4, 'srcline': 14, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_RAINBOW', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'OCEAN', 'type': 'int', 'value': 5, 'srcline': 15, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_OCEAN', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'SUMMER', 'type': 'int', 'value': 6, 'srcline': 16, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_SUMMER', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'SPRING', 'type': 'int', 'value': 7, 'srcline': 17, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_SPRING', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'COOL', 'type': 'int', 'value': 8, 'srcline': 18, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_COOL', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'HSV', 'type': 'int', 'value': 9, 'srcline': 19, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_HSV', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'PINK', 'type': 'int', 'value': 10, 'srcline': 20, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_PINK', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'HOT', 'type': 'int', 'value': 11, 'srcline': 21, 'srcfile': '/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg', 'description': 'COLORMAP_HOT', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'colormap'}", &ImageViewConfig::colormap)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_NO_COLORMAP = -1;
//#line 10 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_AUTUMN = 0;
//#line 11 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_BONE = 1;
//#line 12 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_JET = 2;
//#line 13 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_WINTER = 3;
//#line 14 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_RAINBOW = 4;
//#line 15 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_OCEAN = 5;
//#line 16 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_SUMMER = 6;
//#line 17 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_SPRING = 7;
//#line 18 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_COOL = 8;
//#line 19 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_HSV = 9;
//#line 20 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
      const int ImageView_PINK = 10;
//#line 21 "/tmp/binarydeb/ros-noetic-image-view-1.16.0/cfg/ImageView.cfg"
