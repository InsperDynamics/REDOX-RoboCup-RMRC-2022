...
namespace opencv_apps
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(HoughLinesConfig &config, const HoughLinesConfig &max, const HoughLinesConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const HoughLinesConfig &config1, const HoughLinesConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, HoughLinesConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const HoughLinesConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, HoughLinesConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const HoughLinesConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const HoughLinesConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, HoughLinesConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(HoughLinesConfig::AbstractParamDescriptionConstPtr(new HoughLinesConfig::ParamDescription<int>("hough_type", "int", 0, "Hough Line Methods", "{'enum': [{'name': 'Standard_Hough_Transform', 'type': 'int', 'value': 0, 'srcline': 42, 'srcfile': '/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/HoughLines.cfg', 'description': 'Standard Hough Line', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Probabilistic_Hough_Transform', 'type': 'int', 'value': 1, 'srcline': 43, 'srcfile': '/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/HoughLines.cfg', 'description': 'Probabilistic Hough Line', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for Hough Transform Mehtods'}", &HoughLinesConfig::hough_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(HoughLinesConfig::AbstractParamDescriptionConstPtr(new HoughLinesConfig::ParamDescription<int>("hough_type", "int", 0, "Hough Line Methods", "{'enum': [{'name': 'Standard_Hough_Transform', 'type': 'int', 'value': 0, 'srcline': 42, 'srcfile': '/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/HoughLines.cfg', 'description': 'Standard Hough Line', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Probabilistic_Hough_Transform', 'type': 'int', 'value': 1, 'srcline': 43, 'srcfile': '/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/HoughLines.cfg', 'description': 'Probabilistic Hough Line', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for Hough Transform Mehtods'}", &HoughLinesConfig::hough_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 42 "/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/HoughLines.cfg"
      const int HoughLines_Standard_Hough_Transform = 0;
//#line 43 "/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/HoughLines.cfg"
