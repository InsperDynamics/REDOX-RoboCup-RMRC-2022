...
namespace opencv_apps
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(FaceRecognitionConfig &config, const FaceRecognitionConfig &max, const FaceRecognitionConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const FaceRecognitionConfig &config1, const FaceRecognitionConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, FaceRecognitionConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const FaceRecognitionConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, FaceRecognitionConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const FaceRecognitionConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const FaceRecognitionConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, FaceRecognitionConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(FaceRecognitionConfig::AbstractParamDescriptionConstPtr(new FaceRecognitionConfig::ParamDescription<std::string>("model_method", "str", 0, "Method to recognize faces", "{'enum': [{'name': 'eigen', 'type': 'str', 'value': 'eigen', 'srcline': 41, 'srcfile': '/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/FaceRecognition.cfg', 'description': 'eigen', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'fisher', 'type': 'str', 'value': 'fisher', 'srcline': 42, 'srcfile': '/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/FaceRecognition.cfg', 'description': 'fisher', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'LBPH', 'type': 'str', 'value': 'LBPH', 'srcline': 43, 'srcfile': '/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/FaceRecognition.cfg', 'description': 'LBPH', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Method to recognize faces'}", &FaceRecognitionConfig::model_method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 41 "/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/FaceRecognition.cfg"
      const char * const FaceRecognition_eigen = "eigen";
//#line 42 "/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/FaceRecognition.cfg"
      const char * const FaceRecognition_fisher = "fisher";
//#line 43 "/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/FaceRecognition.cfg"
