...
namespace opencv_apps
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(PyramidsConfig &config, const PyramidsConfig &max, const PyramidsConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const PyramidsConfig &config1, const PyramidsConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, PyramidsConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const PyramidsConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, PyramidsConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const PyramidsConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const PyramidsConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, PyramidsConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(PyramidsConfig::AbstractParamDescriptionConstPtr(new PyramidsConfig::ParamDescription<int>("pyramids_type", "int", 0, "Pyramids Type", "{'enum': [{'name': 'Up', 'type': 'int', 'value': 0, 'srcline': 10, 'srcfile': '/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/Pyramids.cfg', 'description': 'Zoom In', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'Down', 'type': 'int', 'value': 1, 'srcline': 11, 'srcfile': '/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/Pyramids.cfg', 'description': 'Zoom Out', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'An enum for Pyramids Types'}", &PyramidsConfig::pyramids_type)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 10 "/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/Pyramids.cfg"
      const int Pyramids_Up = 0;
//#line 11 "/tmp/binarydeb/ros-noetic-opencv-apps-2.0.2/cfg/Pyramids.cfg"
