...
int main(int argc, char* argv[])
{
	...
	if (!capture.isOpened())
	{
		std::cout << "CAMERA ERROR DETECTED" << std::endl;
	}
	else
	{
		while (true)
		{
			...
			if (imageZbar.symbol_begin() != imageZbar.symbol_end())
			{
				...
				{
					std::cout << "Code Type: " << std::endl << symbol->get_type_name() << std::endl;
					std::cout << "Decode Result: " << std::endl << symbol->get_data() << std::endl;
				}
